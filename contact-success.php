<?php
$page_title = "Carteon - Contact Success";
                        ...
                        <div class="col-lg-12">
                            <div class="it-breadcrumb-content z-index-3">
                                <div class="it-breadcrumb-title-box">
                                    <h3 class="it-breadcrumb-title it-split-text it-split-in-right">Contact Success</h3>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="it-error-content text-center">
                                <h5 class="it-section-title mb-25 it-split-text it-split-in-right">Message Sent Successfully!</h5>
                                <p class="mb-35">Thank you for contacting us. We'll get back to you as soon as possible.</p>
